...
const Aboutus = () => {
  return (
    <Container id="About" maxWidth="lg" className="flex flex-row gap-2 mt-10">
      <Box id="aboutus" className="flex flex-col gap-2 w-1/3 p-4">
      ...
      <Box id="mission" className="flex flex-col gap-2 w-1/3 p-4">
      ...
      <Box id="vision" className="flex flex-col gap-2 w-1/3 p-4">
